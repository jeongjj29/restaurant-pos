...
def seed_data():
    ...
    roles = [
        Role(name="Admin", access_level=5),
        Role(name="Manager", access_level=4),
        Role(name="Chef", access_level=3),
        Role(name="Server", access_level=2),
        Role(name="Bartender", access_level=1),
    ]
